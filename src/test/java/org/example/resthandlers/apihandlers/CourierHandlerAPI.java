...
import org.example.apitest.entities.requestentities.Courier;
import io.qameta.allure.Allure;
import io.qameta.allure.Step;
import io.restassured.response.*;
import org.example.apitest.entities.responseentities.ResponseCourier;
import org.example.resthandlers.httpclients.CourierHTTPClient;

import static org.hamcrest.CoreMatchers.notNullValue;
import static org.hamcrest.core.IsEqual.equalTo;

public class CourierHandlerAPI {
    ...
    public Integer getIdCourier(Response response) {
        return response.body().as(ResponseCourier.class).getId();
    }
