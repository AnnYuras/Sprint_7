...
import org.example.apitest.entities.requestentities.Order;
import org.example.resthandlers.httpclients.OrdersHTTPClient;
import org.example.apitest.entities.responseentities.ResponseOrder;

import java.util.List;

import static org.hamcrest.CoreMatchers.notNullValue;

public class OrdersHandlerAPI {
    ...
    public Integer getTrack(Response response) {
        return response.body().as(ResponseOrder.class).getTrack();
    }
