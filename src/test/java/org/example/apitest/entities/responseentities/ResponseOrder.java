...
public class ResponseOrder {
    ...
    public ResponseOrder(Integer track, String firstName, String lastName, String address, String phone, String rentTime, String deliveryDate, String comment, List<String> scooterColor) {
        this.track = track;
