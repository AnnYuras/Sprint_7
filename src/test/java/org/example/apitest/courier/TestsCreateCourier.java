...
@Feature("Тесты для API по созданию курьера.")
@DisplayName("1. Создание курьера")
public class TestsCreateCourier extends CourierHandlerAPI {

    private String login;
    private String password;
    private String firstName;

    public TestsCreateCourier() {
    }
    ...
    @After
    @Step("Удаление введённых данных после завершения теста.")
