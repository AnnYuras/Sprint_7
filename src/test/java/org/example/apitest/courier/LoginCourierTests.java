...
import org.example.resthandlers.apihandlers.CourierHandlerAPI;
...
@Tag("login-courier")
@Epic("Project.Sprint 7.")
@Feature("Тесты для API авторизации курьера")
@DisplayName("2. Логин курьера")

public class LoginCourierTests extends CourierHandlerAPI {
    ...
    @Description("Данный тест проверяет API для логина курьера. Ожидаемый результат - курьер залогинен в системе, возвращается его id")
    ...
    @Test
    @DisplayName("Вход курьера в систему без указания необходимых данных.")
    @Description("Данный тест проверяет API логина курьера без входных данных. Ожидаемый результат - курьер НЕ залогинен в системе")
    ...
    @Description("Данный тест проверяет API логина курьера без логина. Ожидаемый результат - курьер НЕ залогинен в системе")
    ...
    @Description("Данный тест проверяет API логина курьера без пароля. Ожидаемый результат - курьер НЕ залогинен в системе")
    ...
    @Test
    @DisplayName("Вход курьера в систему с некорректным логином")
    @Description("Данный тест проверяет API логина курьера с некорректным логином. Ожидаемый результат - курьер НЕ залогинен в системе")
    ...
    @Test
    @DisplayName("Авторизация курьера в систему с неверным паролем.")
    @Description("Данный тест проверяет API логина курьера с некорректным паролем. Ожидаемый результат - курьер НЕ залогинен в системе")
